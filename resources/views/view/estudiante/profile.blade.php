...
<div class="container mx-auto py-8">
    ...
    <form action="{{ route('student.update', $profile->user_id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="age" name="age" value="{{ old('age', $profile->age) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="marital_status" class="block text-sm font-medium text-gray-700">Estado Civil</label>
            <input type="text" id="marital_status" name="marital_status" value="{{ old('marital_status', $profile->marital_status) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="has_children" class="block text-sm font-medium text-gray-700">¿Tiene Hijos?</label>
            <input type="text" id="has_children" name="has_children" value="{{ old('has_children', $profile->has_children ? 'Sí' : 'No') }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="address" class="block text-sm font-medium text-gray-700">Dirección</label>
            <input type="text" id="address" name="address" value="{{ old('address', $profile->address) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="phone" class="block text-sm font-medium text-gray-700">Teléfono</label>
            <input type="text" id="phone" name="phone" value="{{ old('phone', $profile->phone) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="health_regime" class="block text-sm font-medium text-gray-700">Régimen de Salud</label>
            <input type="text" id="health_regime" name="health_regime" value="{{ old('health_regime', $profile->health_regime) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="eps_name" class="block text-sm font-medium text-gray-700">Nombre de la EPS</label>
            <input type="text" id="eps_name" name="eps_name" value="{{ old('eps_name', $profile->eps_name) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="sisben_classification" class="block text-sm font-medium text-gray-700">Clasificación Sisbén</label>
            <input type="text" id="sisben_classification" name="sisben_classification" value="{{ old('sisben_classification', $profile->sisben_classification) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="academic_program" class="block text-sm font-medium text-gray-700">Programa Académico</label>
            <input type="text" id="academic_program" name="academic_program" value="{{ old('academic_program', $profile->academic_program) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="schedule" class="block text-sm font-medium text-gray-700">Horario</label>
            <input type="text" id="schedule" name="schedule" value="{{ old('schedule', $profile->schedule) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>

        <div class="mb-4">
            <label for="disability" class="block text-sm font-medium text-gray-700">Discapacidad</label>
            <input type="text" id="disability" name="disability" value="{{ old('disability', $profile->disability) }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" disabled>
        </div>
